...
public class DataInitializer implements CommandLineRunner {
    ...
    private void seedData() throws IOException {
        ...
        UserDTO user1 = new UserDTO(null,"Done", "123123", "jon", "johh", true, role1 , "sdfoisdv", sqlDate, sqlDate);

        UserDTO user2 = new UserDTO(null, "Done", "123123", "jon", "johh", true, role2 , "sdfoisdv", sqlDate, sqlDate);
...
//        brandsRepository.save(brand2);
        ...
        ModelsDTO model1 = new ModelsDTO(null,"Model 1", Category.Car, "image_url_1", 2022, 2023, sqlDate,sqlDate, brand1);
        ModelsDTO model2 = new ModelsDTO(null,"Model 2", Category.Truck, "image_url_2", 2021, 2022, sqlDate,sqlDate, brand2);
...
//        rolseRepository.save(role2);
        ...
        OffersDTO offers2 = new OffersDTO(null, "Offer 1 descriotion", Engine.ELECTRIC, "url", 1000, 1, Transmission.AUTOMATIC, sqlDate,sqlDate,sqlDate,model1,user1);
